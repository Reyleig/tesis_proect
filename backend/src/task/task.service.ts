...
export class TaskService {
  ...
  async updateTask(updateTaskDto: UpdateTaskDto) {    
    ...
    let task: Task =new Task(updateTaskDto.id, user.id, updateTaskDto.tituloTarea, updateTaskDto.descripcionTarea);

    let result = await this.taskRepository.save(task);
